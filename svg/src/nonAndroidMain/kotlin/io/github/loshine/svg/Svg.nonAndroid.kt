 ...
 *
 * Uses Compose Multiplatform's built-in [painterResource] function to handle SVG resources. On
 * non-Android platforms, the framework's default SVG support is sufficient.
 *
